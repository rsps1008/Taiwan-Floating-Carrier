...
漂浮載具是一款開源、免費的 Android App，讓你把台灣手機條碼放在螢幕上方，需要結帳時快速展開出示。除了可拖曳的浮動視窗，也提供桌面小工具，支援直接開啟浮窗、複製載具號碼，或開啟指定的其他 App。
...
- 小工具點擊可選擇開啟浮窗、將完整載具號碼複製到剪貼簿並顯示 Toast，或從已安裝的 App 中選擇要開啟的 App。
